...
def main():
    ...
    if coords is None:
        ...
        plot_scatter(
            coords,
            df,
            filename='svd_scatter.png',
            title='SVD scatter',
            axis_limits=svd_limits,
            label_col='Guideline + Slogan',
            annotate_top_n=12,
            metric=DIST_METRIC,
        )
        ...
        if coords_umap is not None:
            ...
            plot_scatter(
                coords_umap,
                df,
                filename='umap_scatter.png',
                title='UMAP scatter',
                axis_limits=umap_limits,
                label_col='Guideline + Slogan',
                annotate_top_n=12,
                metric=DIST_METRIC,
            )
        ...
        if coords_tsne is not None and coords_umap is not None:
            ...
            plot_comparison(
                ...
                coords_umap,
                df,
                filename='tsne_vs_umap.png',
                titles=('t-SNE', 'UMAP'),
                mode='per',
                axis_limits_a=tsne_limits,
