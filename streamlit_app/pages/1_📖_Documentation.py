...
2. [Selection & Grouping](#selection-grouping)
3. [Document Analysis and Comparison](#document-analysis-and-comparison)
4. [Visual Settings](#visual-settings)
5. [Analytical Workflows](#analytical-workflows)
...
## 3. Document Analysis and Comparison
